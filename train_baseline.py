...
train=pd.read_csv('input/train_0420.csv',low_memory=False)
test = pd.read_csv('input/test_0420.csv',low_memory=False)
...
# sub_file = "submission_041922_5fold.csv"
...
# sub = pd.concat([test_vid, pred_test], axis=1)
# sub.to_csv("submission_352041720_2.csv", float_format='%.3f', index=False, header=False)
